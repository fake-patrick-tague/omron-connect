...
class ChildHelper
{
  ...
  View findHiddenNonRemovedView(int paramInt)
  {
    ...
    while (i < j)
    {
      ...
      RecyclerView.b0 localB0 = mCallback.getChildViewHolder(localView);
  ...
  abstract interface Callback
  {
    ...
    public abstract void attachViewToParent(View paramView);
    ...
    public abstract RecyclerView.b0 getChildViewHolder(View paramView);
