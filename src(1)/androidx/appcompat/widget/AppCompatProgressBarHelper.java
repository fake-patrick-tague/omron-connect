...
class AppCompatProgressBarHelper
{
  ...
  Drawable tileify(Drawable paramDrawable, boolean paramBoolean)
  {
    ...
    {
      localObject1 = (Integer)paramDrawable;
      localObject2 = ((Integer)localObject1).getWrappedDrawable();
      if (localObject2 != null)
      {
        ((Integer)localObject1).setWrappedDrawable(tileify((Drawable)localObject2, paramBoolean));
        return paramDrawable;
      }
    }
    else
      ...
      if ((paramDrawable instanceof LayerDrawable))
      {
        ...
        while (i < k)
        {
          ...
          if (Build.VERSION.SDK_INT >= 23) {
            StateListAnimator.addState(paramDrawable, (LayerDrawable)localObject1, i);
          }
          i += 1;
        }
        return localObject1;
