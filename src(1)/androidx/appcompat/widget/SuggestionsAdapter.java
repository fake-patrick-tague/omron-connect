...
import v7.v4.widget.ResourceCursorAdapter;
  ...
  implements View.OnClickListener
{
  ...
  private Drawable getActivityIconWithCache(ComponentName paramComponentName)
  {
    ...
    if (bool)
    {
      ...
      return paramComponentName.newDrawable(mContext.getResources());
    }
  ...
  {
    paramContext = (h0.a)paramView.getTag();
    int i = mText2Col;
    if (i != -1) {
  ...
  public View getDropDownView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    catch (RuntimeException paramView)
    {
      ...
      paramViewGroup = newDropDownView(mContext, getCursor(), paramViewGroup);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    {
      Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", paramView);
      paramViewGroup = newView(mContext, getCursor(), paramViewGroup);
      if (paramViewGroup != null) {
        getTagmText1.setText(paramView.toString());
      }
    }
  ...
  public View newView(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    paramContext.setTag(new h0.a(paramContext));
