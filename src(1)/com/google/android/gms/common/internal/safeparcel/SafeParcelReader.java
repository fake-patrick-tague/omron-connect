...
public class SafeParcelReader
{
  ...
  private static void addAttribute(Parcel paramParcel, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public static Boolean readBooleanObject(Parcel paramParcel, int paramInt)
  {
    ...
    addAttribute(paramParcel, paramInt, i, 4);
    boolean bool;
    if (paramParcel.readInt() != 0) {
      bool = true;
    } else {
  ...
  public static Double readDoubleObject(Parcel paramParcel, int paramInt)
  {
    ...
    addAttribute(paramParcel, paramInt, i, 8);
  ...
  public static int validateObjectHeader(Parcel paramParcel)
  {
    ...
    throw new ParseException("Expected object header. Got 0x".concat(String.valueOf(Integer.toHexString(j))), paramParcel);
  }
