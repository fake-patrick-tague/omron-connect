  ...
  extends GooglePlayServicesUtilLight
{
  ...
  public static boolean showErrorDialogFragment(int paramInt1, Activity paramActivity, Fragment paramFragment, int paramInt2, DialogInterface.OnCancelListener paramOnCancelListener)
  {
    ...
    paramFragment = localGoogleApiAvailability.create(paramActivity, i, Preference.inflate(paramFragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(paramActivity, i, "d"), paramInt2), paramOnCancelListener);
    if (paramFragment == null) {
      return false;
    }
    localGoogleApiAvailability.show(paramActivity, paramFragment, "GooglePlayServicesErrorDialog", paramOnCancelListener);
    return true;
  }
  ...
  public static void showErrorNotification(int paramInt, Context paramContext)
  {
    ...
    localGoogleApiAvailability.init(paramContext);
  }
}
