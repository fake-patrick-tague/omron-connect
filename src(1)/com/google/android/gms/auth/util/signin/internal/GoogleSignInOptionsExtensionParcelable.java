...
{
  public static final Parcelable.Creator<com.google.android.gms.auth.api.signin.internal.GoogleSignInOptionsExtensionParcelable> CREATOR = new DiscreteSeekBar.CustomState.1();
  @SafeParcelable.Field(getter="getType", id=2)
  private int declType;
  @SafeParcelable.VersionField(id=1)
  final int endHour;
  @SafeParcelable.Field(getter="getBundle", id=3)
  private Bundle syncState;
  
  GoogleSignInOptionsExtensionParcelable(int paramInt1, int paramInt2, Bundle paramBundle)
  {
    endHour = paramInt1;
    declType = paramInt2;
    syncState = paramBundle;
  }
  ...
  public final void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    SafeParcelWriter.writeBundle(paramParcel, 3, syncState, false);
