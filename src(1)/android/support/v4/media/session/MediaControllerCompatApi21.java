...
class MediaControllerCompatApi21
{
    ...
    extends MediaController.Callback
  {
    ...
    public CallbackProxy(MediaControllerCompatApi21.Callback paramCallback)
    {
    ...
    {
      mCallback.onAudioInfoChanged(paramPlaybackInfo.getPlaybackType(), MediaControllerCompatApi21.PlaybackInfo.getLegacyAudioStream(paramPlaybackInfo), paramPlaybackInfo.getVolumeControl(), paramPlaybackInfo.getMaxVolume(), paramPlaybackInfo.getCurrentVolume());
    }
    
    public void onExtrasChanged(Bundle paramBundle)
    {
      MediaSessionCompat.ensureClassLoader(paramBundle);
      mCallback.onExtrasChanged(paramBundle);
    }
    ...
    {
      mCallback.onQueueChanged(paramList);
    }
    
    public void onQueueTitleChanged(CharSequence paramCharSequence)
    {
      mCallback.onQueueTitleChanged(paramCharSequence);
    }
