...
{
  private static final String PAGE_KEY = "MediaSessionCompatApi24";
  ...
  public static String getCallingPackage(Object paramObject)
  {
    ...
    catch (IllegalAccessException paramObject) {}catch (InvocationTargetException paramObject) {}catch (NoSuchMethodException paramObject) {}
  ...
  {
    public CallbackProxy(MediaSessionCompatApi24.Callback paramCallback)
    {
      super();
    }
